...
const totalPages = useMemo(() => {
  ...
  return (
    <div className="max-w-full mx-auto p-4 bg-gray-50 dark:bg-gray-900 min-h-screen transition-colors duration-300">
      <h1 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Manajemen Perusahaan</h1>
      ...
      <div className="mb-4 bg-white dark:bg-gray-800 p-4 rounded-lg">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="mb-2">
            <label className="block text-sm font-medium text-gray-900 dark:text-white">Nama Perusahaan</label>
            <input
              type="text"
              value={nama}
          ...
          <div className="mb-2">
            <label className="block text-sm font-medium text-gray-900 dark:text-white">Alamat Perusahaan</label>
            <input
              type="text"
              value={alamat}
